...
export default function VeristaPage() {
  const amenities = [
    { icon: <Trees className="w-6 h-6" />, label: "Landscaped Courtyard" },
    { icon: <Home className="w-6 h-6" />, label: "Multipurpose Hall" },
    { icon: <Star className="w-6 h-6" />, label: "Concierge Service" },
    { icon: <ShieldCheck className="w-6 h-6" />, label: "Advanced Security" },
    { icon: <Sun className="w-6 h-6" />, label: "Solar Energy" },
    { icon: <Dumbbell className="w-6 h-6" />, label: "Fitness Suite" },
    { icon: <Layout className="w-6 h-6" />, label: "Business Lounge" },
    { icon: <Cpu className="w-6 h-6" />, label: "EV Charging" },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              ...
              <h1 className="text-5xl md:text-8xl font-serif leading-none mb-6 text-[#2B2B2B]">Verïsta<span className="text-[#8A7A63] italic">.</span></h1>
              <div className="flex items-center gap-2 text-[10px] tracking-[0.5em] uppercase text-[#2B2B2B]/40">
                <MapPin className="w-3 h-3" />
                <span>Law College Road, Pune</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-start mb-32">
            <div className="space-y-8">
              <h2 className="text-3xl md:text-5xl font-serif text-[#2B2B2B]">Contemporary <br /> heritage.</h2>
          ...
          <section className="mb-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative h-[400px] md:h-[500px] w-full shadow-2xl border border-[#D8D2C8]">
                <iframe
                  src="https://www.google.com/maps?q=Law+College+Road+Pune&output=embed"
                  width="100%"
                  height="100%"
          ...
          <section className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
               ...
               <div className="relative aspect-[4/5] overflow-hidden group">
                  <Image src="/images/Verista.png" alt="Exterior View" fill className="object-cover transition-transform duration-1000 group-hover:scale-105" />
                  <div className="absolute inset-0 bg-black/5" />
               </div>
            </div>
          </section>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-6xl font-serif text-[#2B2B2B]">Contemporary Heritage.</h2>
            <p className="text-lg font-light text-[#2B2B2B]/60 italic max-w-xl mx-auto">
              Own a piece of history in Law College Road. Reach out for a specialized property tour.
            </p>
            <div className="pt-6">
              <Link href="/contact">
