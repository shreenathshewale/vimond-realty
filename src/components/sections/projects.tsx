...
export function Projects() {
  const featuredProjects = projects.filter(p => p.status === 'ongoing');
              ...
              >
                <div className="w-full lg:w-3/5 relative">
                  ...
                  <div className={cn(
                    ...
                    idx % 2 === 0 ? "-top-6 -left-6 md:-top-12 md:-left-12 group-hover:-translate-x-2 group-hover:-translate-y-2" : "-bottom-6 -right-6 md:-bottom-12 md:-right-12 group-hover:translate-x-2 group-hover:translate-y-2"
                  )} />
                </div>
