    ...
    <section id="projects" className="section-spacing bg-white">
      <div className="container-max">
        <div className="mb-16 md:mb-24 md:text-center">
          ...
          >
            <span className="text-[10px] tracking-[0.6em] uppercase text-primary font-bold block mb-4">Portfolio</span>
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-serif text-foreground uppercase tracking-tight mb-6 leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 mb-24 md:mb-32">
            ...
            >
              ...
              <div className="p-8 md:p-10 space-y-6">
                <div>
                  ...
                  <h3 className="text-2xl md:text-3xl font-serif mb-4 leading-none">{project.name}</h3>
        ...
        <div className="pt-24 border-t border-black/5">
          <div className="mb-12 md:mb-16">
            ...
            <p className="text-[10px] font-light text-foreground/40 uppercase tracking-[0.3em] mt-4">Building enduring legacies since inception.</p>
          </div>
