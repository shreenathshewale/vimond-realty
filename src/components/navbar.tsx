  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#1F1F1F]/90 backdrop-blur-md border-b border-white/5 shadow-lg">
      <div className="max-w-7xl mx-auto px-8 h-24 flex justify-between items-center">
        ...
        <Link href="/contact">
          <Button variant="outline" className="rounded-none border-[#8A7A63]/50 text-[#8A7A63] text-[9px] tracking-[0.3em] uppercase px-8 h-10 hover:bg-[#8A7A63] hover:text-white transition-all bg-transparent">
            Inquiry
          </Button>
        </Link>
      </div>
